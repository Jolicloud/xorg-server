...
#define OSNAME "Linux 2.6.27-0.290.rc5.fc10.i686 i686"
...
#define PACKAGE_STRING "xorg-server 1.5.0"
...
/* Vendor man version */
#define XORG_MAN_VERSION "Version 1.5.0"

/* Building Xorg server */
#define XORG_SERVER 1

/* Current Xorg version */
#define XORG_VERSION_CURRENT (((1) * 10000000) + ((5) * 100000) + ((0) * 1000) + 0)
