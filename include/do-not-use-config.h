...
#define OSNAME "Linux 2.6.27-0.148.rc0.git2.fc10.x86_64 x86_64"
...
#define PACKAGE_STRING "xorg-server 1.4.99.906"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "xorg-server"

/* Define to the version of this package. */
#define PACKAGE_VERSION "1.4.99.906"
...
/* Vendor man version */
#define XORG_MAN_VERSION "Version 1.4.99.906"

/* Building Xorg server */
#define XORG_SERVER 1

/* Current Xorg version */
#define XORG_VERSION_CURRENT (((1) * 10000000) + ((4) * 100000) + ((99) * 1000) + 906)
